...
#define  USB_CFG_VENDOR_ID       0xA3, 0xA3 /* = 0x16c0 = 5824 = voti.nl */
 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0x80, 0x15 /* = 0x05dc = 1500 */
 ...
 */
#define USB_CFG_VENDOR_NAME     'A', 'n', 'g', 'e', 'l', 'P', 'u', 'p', 'p', 'y'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'V', 'i', 's', 't', 'a', '8', '0', ' ', 'C', 'o', 'n', 't', 'r', 'o', 'l', 'l', 'e', 'r'
#define USB_CFG_DEVICE_NAME_LEN 18
/* Same as above for the device name. If you don't want a device name, undefine
 * the macros. See the file USB-IDs-for-free.txt before you assign a name if
 * you use a shared VID/PID.
 */
//#define USB_CFG_SERIAL_NUMBER   'j', 'o', 'u', 'e', 'l', 'l', 'e', 't', '.', 'n', 'e', 't', ':', '0', '1'
